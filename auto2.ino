...
//const int signalLoad = A6;
//const int signalUnload = A7;
const int signal[] = {13, A6, A7};
...
void motorOnOff(int totalMotor) {
  ...
  if (motorState == false) {
    ...
    digitalWrite(signal[signalPin], HIGH);
